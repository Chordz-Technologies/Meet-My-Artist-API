...
class Events(models.Model):
    ...
    elocation = models.CharField(db_column='Elocation', max_length=100, blank=True, null=True)
    ...
    uname = models.ForeignKey(User, models.DO_NOTHING, db_column='Uname', related_name='events_uname_set', blank=True, null=True)
    obusinessname = models.ForeignKey(User, models.DO_NOTHING, db_column='Obusinessname', related_name='events_obusinessname_set', blank=True, null=True)
